...
/**
 * 10:00、官邸4階の閣議室。土曜なので定例ではなく臨時閣議になる。
 *
 * 実際の閣議は形式的な進行で、官房長官が案件を読み上げ、担当大臣が短く
 * 説明し、署名して終わる。長い議論はここではしない。だから場面としても
 * 短い案件の連なりにしてあり、判断は「何を言うか」と「終わったあとで誰を
 * 残すか」の二つに絞ってある。
 */
export const CABINET: Meeting = {
  ...
  opening: [
    ...
    {
      speaker: "官房長官",
      text: "「ただいまから臨時閣議を開催いたします。本日の案件は三件でございます」",
    },
    {
      speaker: "官房長官",
      text: "「まず、公務員給与法の一部改正の政令につきまして、内閣官房副長官からご説明申し上げます」\n\n副長官が二分で読み上げ、誰も何も言わなかった。署名簿が回ってくる。",
    },
    {
      speaker: "官房長官",
      text: "「次に、大臣発言がございます。財務大臣から一件」",
    },
    {
      speaker: "財務大臣",
      text: "「経済対策の財源につきまして、来週中に選択肢を整理してお示しいたします。以上です」\n\n二十秒だった。ここで長く話す人はいない。",
    },
  ],
  prompt: "「総理から、何かございますか」",
  choices: [
    {
      id: "cabinet-address",
      label: "一言、述べる",
    ...
    },
    {
      ...
      reply: [
        {
          speaker: "官房長官",
          text: "「骨子を来週中に。閣議決定は再来週の火曜を想定しております」",
        },
        {
    ...
    {
      id: "cabinet-first",
      label: "この内閣で最初の閣議であることに触れる",
      note: "一度しか言えないこと",
      minutes: 5,
      flags: ["marked-the-first"],
      highlight: "最初の閣議であることに、自分から触れた。",
      reply: [
        {
          text: "「昨日の初閣議は、組閣の当日で、署名だけで終わりました。中身のある閣議は、今日が最初になります」",
        },
        {
          text: "「この十九人で、どこまで行けるか分かりません。ただ、私はこの顔ぶれを自分で選びました。選んだ責任は、全部こちらにあります」",
        },
        {
          text: "部屋の温度が少し変わった気がした。気のせいかもしれない。\n\n官房長官が、こちらを見て小さく頷いた。",
        },
      ],
    },
    {
      ...
      highlight: "案件の外で、閣僚それぞれの懸案を聞いた。",
      reply: [
        {
          text: "「案件の外で、いま抱えているものがあれば、一人一分でお願いします」\n\n官房長官が一瞬こちらを見た。予定にない進行だった。",
        },
        {
          text: "十九人。一分ずつでは終わらなかった。\n\n半分は事前に紙で読んでいる内容だった。だが、読むのと、その人が言うのを聞くのとでは違った。",
        },
        {
    ...
    },
    {
      ...
      reply: [
        {
          text: "「特にありません」\n\n署名の順が回ってくる。名前を書く。それだけで、閣議は動いていく。\n\n自分がいなくても回る仕組みなのだと、そのとき初めて具体的に分かった。",
        },
      ],
    },
    {
      id: "cabinet-hold",
      label: "終わったあとで、一人だけ残ってもらう",
      note: "誰を呼び止めるかは、外から見えている",
      minutes: 10,
      flags: ["held-a-minister"],
      highlight: "閣議のあと、財務大臣だけを残した。",
      reply: [
        {
          text: "「財務大臣、少しよろしいですか」\n\n十八人が出ていく。出ていきながら、何人かがこちらを見た。",
        },
        {
          speaker: "財務大臣",
          text: "「……はい」",
        ...
        {
          text: "五分だけ、財源の話をした。中身は電話で足りることだった。それでも直接聞きたかった。",
        },
        {
          speaker: SAWATARI.shortName,
          text: "「総理。閣議のあとに誰を残したかは、廊下で見られています」\n\n部屋を出たところで、沢渡が並んで歩きながら言った。\n\n「夕方には『財務と何を話したのか』が記事になります。中身は誰も知りませんが、残した、という事実だけで十分に記事になります」",
        },
      ],
    },
  ],
