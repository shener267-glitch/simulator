    ...
    <Modal title="内閣改造" onClose={onClose}>
      ...
      <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
        <button
          type="button"
          onClick={onClose}
          className="rounded-md px-4 py-3 text-slate-400 hover:bg-slate-700"
        >
          やめる
        </button>
        <button
          type="button"
          onClick={onConfirm}
          className="rounded-md bg-indigo-600 px-4 py-3 font-medium text-white hover:bg-indigo-500"
        >
          内閣改造を行う
        </button>
      </div>
